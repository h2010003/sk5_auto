...
curl -kLs https://raw.githubusercontent.com/reno1314/danted/master/install_R.sh -o install.sh && bash install.sh  --port=32479 --user=123 --passwd=321123 && /etc/init.d/sockd start
