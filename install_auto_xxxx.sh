...
curl -kLs https://raw.githubusercontent.com/reno1314/danted/master/install_R.sh -o install.sh && bash install.sh  --port=11479 --user=xl --passwd=123 && /etc/init.d/sockd start
